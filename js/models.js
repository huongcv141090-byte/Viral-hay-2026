...
(function (global) {
     ...
     * ------------------------------------------------------------------------- */
    const CHAT_MODELS = [
        { id: 'gpt-5.6-luna',       label: 'GPT-5.6 Luna',            vendor: 'OpenAI',    badge: 'CATALOG', note: 'Flagship OpenAI, web search builtin' },
        { id: 'gpt-5.5',            label: 'GPT-5.5',                 vendor: 'OpenAI',    badge: 'CATALOG',      note: 'Cân bằng chi phí/chất lượng' },
    ...
    const IMAGE_MODELS = [
        ...
        },
        {
            ...
            vendor: 'Replicate', badge: 'CATALOG',
    ...
    const VIDEO_MODELS = [
        {
            id: 'veo-3.1', label: 'Veo 3.1 (Cinematic 4K)', vendor: 'Google', badge: 'CATALOG',
        ...
        {
            id: 'veo-3.1-fast', label: 'Veo 3.1 Fast', vendor: 'Google', badge: 'CATALOG',
            seconds: [4, 6, 8], sizes: ['1280x720', '720x1280', '1920x1080', '1080x1920', '3840x2160', '2160x3840'],
        ...
        {
            id: 'seedance-2-5', label: 'Seedance 2.5', vendor: 'BytePlus', badge: 'CATALOG',
        ...
        {
            id: 'seedance-2-0', label: 'Seedance 2.0', vendor: 'BytePlus', badge: 'CATALOG',
        ...
        {
            id: 'wan-ai/wan2.7-i2v', label: 'Wan 2.7 (Image-to-Video)', vendor: 'Together AI', badge: 'CATALOG',
        ...
        {
            id: 'wan-ai/wan2.7-t2v', label: 'Wan 2.7 (Text-to-Video)', vendor: 'Together AI', badge: 'CATALOG',
            seconds: { min: 2, max: 15, def: 5 }, sizes: ['720P', '1080P'],
    ...
    const TTS_PROVIDERS = [
        {
            ...
            models: [
                { id: 'eleven_v3', label: 'Eleven v3', badge: 'CATALOG', note: 'Cảm xúc và biểu đạt đỉnh nhất' },
        ...
        {
            id: 'gemini', label: 'Gemini TTS', badge: 'CATALOG',
            models: [
                { id: 'gemini-3.1-flash-tts-preview', label: 'Gemini 3.1 Flash TTS', badge: 'CATALOG', note: 'TTS thế hệ mới nhất của Google' },
                { id: 'gemini-2.5-pro-preview-tts', label: 'Gemini 2.5 Pro TTS', badge: '', note: 'Chất lượng pro' },
                { id: 'gemini-2.0-flash-preview-tts', label: 'Gemini 2.0 Flash TTS (legacy)', badge: 'DEFAULT', note: 'Nhanh, 30 giọng dựng sẵn' },
            ],
        ...
        {
            id: 'xai', label: 'Grok TTS (xAI)', badge: 'CATALOG',
        ...
        },
        {
            ...
            models: [
                { id: 'simba-3.2', label: 'Simba 3.2', badge: 'CATALOG/DEFAULT', note: 'Bản mới nhất' },
    ...
    const STT_MODELS = [
        { id: 'gpt-4o-transcribe-diarize', label: 'GPT-4o Transcribe Diarize', badge: 'CATALOG', note: 'Tách người nói, xuất SRT/VTT' },
